...
class DataLoader(AbstractDataLoader):
    ...
    def __init__(self, rank: int, config, train: bool):
        ...
        self.training_path = Path(config.data_dir) / './ImageNetStylized/data/dataset_train_jpg_100.beton'
        self.validation_path = Path(config.data_dir) / './ImageNetStylized/data/dataset_val_jpg_100.beton'
